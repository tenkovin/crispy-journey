gmx editconf -f $1.pdb -o $1.gro -c -box 5.5 5.5 8.2
gmx solvate -cp $1.gro -cs tip3.gro -o $1_solv.gro -p topol.top
pymol $1_solv.gro &
echo 'anykey when use remove_water, saved retaining order with name of ${1}_solv_cut.pdb'
read varname
### open pymol, use remove_water, save retaining order
python3 count.py $1_solv_cut.pdb AMB 138 ERG 73 DMPC 118 TIP3 3 >> topol.top
gedit topol.top &
echo 'anykey when used count, edited topol.top'
read varname1
gmx editconf -f $1_solv_cut.pdb -o $1_solv_cut.gro -c -box 5.5 5.5 8.2
